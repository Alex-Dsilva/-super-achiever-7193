      ...
      <>
        <Flex justifyContent='space-around' className="whole" bg='#fff' mb='8px' pl='5rem' pr='5rem'>
          ...
          <Popover trigger='hover' >
            <PopoverTrigger>
              <Center fontWeight={'600'} _hover={{ color: "#2874f0", cursor: "pointer" }} className='secnav'>Women's Fashion <ChevronDownIcon _hover={{ transform: "rotate(180deg)" }} /></Center>
            </PopoverTrigger>
          ...
          <Popover trigger='hover' >
            <PopoverTrigger>
              <Center fontWeight={'600'} _hover={{ color: "#2874f0", cursor: "pointer" }}>Men's Fashion <ChevronDownIcon _hover={{ transform: "rotate(180deg)" }} /></Center>
            </PopoverTrigger>
            <PopoverContent w='1100px'  >
...
{/* ======================Electronics=============== */}
          ...
          <Popover trigger='hover' >
            <PopoverTrigger>
              <Center fontWeight={'600'} _hover={{ color: "#2874f0", cursor: "pointer" }} className='secnav'>Gadgest<ChevronDownIcon _hover={{ transform: "rotate(180deg)" }} /></Center>
            </PopoverTrigger>
